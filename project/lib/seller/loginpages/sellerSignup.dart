  ...
  Form(
    ...
    Row( mainAxisAlignment: MainAxisAlignment.center,
      children: [ 
        ...
        Text("Individual"),
Radio(   value: "Individual", groupValue: business, onChanged: (value) {
...
Text("Company"),            
Radio(value: "Company", groupValue: business, onChanged: (value) {
  business=value.toString();
  setState(() {
...
if(email.toString().isEmpty){
                          return 'Please enter email in correct form';
                         }
                         else{return null;}
                       },
                      ...
                      child: TextFormField(
                        ...
                        validator: (username) {
                         ...
                         else if(username.toString().length<9 || username.toString().length>12 ){
                          return 'Please correct your number 03312345678 or 3312345678';
                         }
                         else{return null;}
                       },
...
margin: EdgeInsets.all(20),
  ...
  TextButton(
                      onPressed: () {
                        Navigator.pushReplacement(context,MaterialPageRoute(builder: (context) => sellerlog(),));
                      },
                      child: Container( 
                        height: 50,
                        // decoration: BoxDecoration(border: Border.all(color: Colors.black,)),
