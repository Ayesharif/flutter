...
import 'package:project/login%20pages/forgetpass.dart';
import 'package:project/login%20pages/signup.dart';
...
onFieldSubmitted: (value) => FocusScope.of(context).requestFocus(password),
         ...
         obscuringCharacter: '*',
                ...
                TextButton(onPressed: (){ Navigator.push(context,MaterialPageRoute(builder: (context)=>forgetpass()));}, child: Text('Forgot Password ? ',style: TextStyle(fontSize: 20,color: Colors.black,fontWeight: FontWeight.w500),)),
